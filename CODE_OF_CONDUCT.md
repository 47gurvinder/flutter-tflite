...
All project forums and spaces are meant for professional interactions, and any
...
This Code of Conduct applies to all project spaces associated with
`47gurvinder/flutter-tflite`, including issues, Pull Requests, discussions, and
other communication channels used by this community-maintained project.
...
[contact@gurwinderdevx.com](mailto:contact@gurwinderdevx.com). The maintainer
will review the report and determine an appropriate response, which can include
a warning, removal of content, or temporary or permanent exclusion from project
spaces. Please do not use a public issue to report sensitive conduct matters.
...
If the maintainer receives a report alleging a violation, the accused will
normally be notified and given an opportunity to respond before a sanction is
issued. The maintainer will protect the reporter's privacy as far as reasonably
possible. If conduct is ongoing or threatens someone's safety, interim action
